...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="group border border-slate-800/80 bg-pink-50/70 rounded-2xl p-5 flex flex-col gap-3 hover:border-pink-300/70 hover:bg-pink-200/40 transition-all"
    >
